      ...
      <S.ModalInner>
        <S.ModalText>
          ...
          <S.ModalTitle
            ...
            color="#C9542F"
          >
            연등 작성 내용의 모든 책임은 작성자에게 <br />
            있으며 이루미는 어떠한 책임도 입장도 <br />
            가지고 있지 않습니다.
          </S.ModalTitle>

          <S.ModalTitle color="#744A21">서비스 주의사항 안내</S.ModalTitle>
          <S.ModalContentBox>
            <S.ModalContent style={{ whiteSpace: "pre", color: "#744A21" }}>
              (1) 닉네임, 비밀번호 기입이 필수입니다. 욕설 및 <br />
              {"      "}부적절한 단어를 사용했을 시 등록이 제한됩니다.
            </S.ModalContent>
            <S.ModalContent style={{ whiteSpace: "pre", color: "#744A21" }}>
              (2) 신고 접수된 연등은 운영자의 검토 후 삭제될 수 <br />
              {"      "}
              있습니다.
            </S.ModalContent>
            <S.ModalContent style={{ whiteSpace: "pre", color: "#744A21" }}>
